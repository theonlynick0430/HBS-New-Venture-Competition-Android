...
public class Sponsor implements Comparable<Sponsor> {
    ...
    public Sponsor(String name, String description, String logoImageURL, String prize, String website, String repFirstName, String repLastName, String repEmail, Double order){
        this.name = name;
